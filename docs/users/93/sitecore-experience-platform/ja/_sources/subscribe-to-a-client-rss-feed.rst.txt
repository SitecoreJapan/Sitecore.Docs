...
または、コンテンツ エディターから下部のページバーにある「ワークボックス」を開くこともできます。
...
ブラウザで購読しているクライアントのRSSフィードをすべて表示することができます。Internet Explorerで、[お気に入り]パネルの[フィード]タブをクリックして、アイテムのフィードへのリンクをクリックします。
