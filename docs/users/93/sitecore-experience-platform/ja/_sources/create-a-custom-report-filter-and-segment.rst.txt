...
エクスペリエンス アナリティクスでは、ディメンジョンとセグメントを使用して、レポートで使用するチャートを作成します。
...
エクスペリエンス アナリティクスには、いくつかのデフォルトのディメンジョンとセグメントが用意されていますが、必要に応じて独自のディメンジョンを作成することもできます。ディメンジョンとフィルタを組み合わせてセグメントを作成します。
...
5. 新しいフィルタアイテムを設定するには、右ペインの [データ] セクションで、[ルールの編集] をクリックします。
...
カスタムフィルタを作成したら、新しいフィルタにリンクするセグメントアイテムを作成します。
...
2. カスタム・セグメント定義アイテムを作成するには、関連するディメンジョンをクリックします。例えば、[エントリ・ページ別] ディメンジョンなどです。

3. カスタム・セグメントアイテムを作成するには、リボンの [ホーム] タブの [挿入] グループで [セグメント] をクリックします。
