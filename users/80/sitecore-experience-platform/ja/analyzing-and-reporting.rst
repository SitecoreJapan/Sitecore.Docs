...
The experience optimization features offer you a variety of methods to test content, ranging from page tests and basic content tests to component tests and personalization tests. You can see results for individual tests in the エクスペリエンス エディター, and you can use reports and dashboards in Experience Optimization to analyze optimization data.
