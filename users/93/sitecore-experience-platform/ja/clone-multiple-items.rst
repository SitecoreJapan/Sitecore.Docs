...
.. note:: Sitecoreで検索すると、コンテンツツリーで選択したアイテムから検索が開始され、検索結果は検索された順に表示されます。このようにして、検索はより迅速に行われ、最も関連性の高い結果が最初に表示されます。

2. コンテンツエリアで「検索」タブをクリックし、検索キーワードを入力してENTERを押します。

.. note:: ファセットやフィルターを使って検索を絞り込み、クローン化したいアイテムだけをリストアップします。
