...
* :doc:`アイテムの公開 <publish-an-item-to-your-website>` - コンテンツエディタまたはエクスペリエンスエディタで選択したアイテムを公開します。アイテムは、その祖先がすべて公開されている場合にのみ公開できます。アイテム公開では、選択したアイテムのサブアイテムと関連するアイテムをすべて含めることができます。
