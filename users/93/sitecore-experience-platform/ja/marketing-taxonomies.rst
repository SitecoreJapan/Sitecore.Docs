...
:doc:`カスタムマーケティングタクソノミ <create-and-implement-a-custom-marketing-taxonomy>` は、マーケティングコントロールパネルとキャンペーンクリエーターで作成することができます。
