...
1. コンテンツ ツリー内の既存のコンテンツを参照するには、[テスト コンテンツ項目] フィールドで、[参照 |icon2| ] をクリックします。
...
2. 関連付けられたコンテンツの選択 ダイアログ ボックスが表示されます。
    ...
    * 既存の項目を複製してから編集するには、[現在のコンテンツの複製 |icon5| ]をクリックします。
    * 新しいコンテンツ項目を挿入するには、[新しいコンテンツの作成] |icon6| をクリックします。
