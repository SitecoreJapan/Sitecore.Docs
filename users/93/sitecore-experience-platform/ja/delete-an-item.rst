...
.. note:: 
    ...
    ウェブサイトから一時的にアイテムを削除したい場合は、アイテムをアーカイブ ( :doc:`archive-and-restore-an-item` ) することができます。アイテムをアーカイブすると、削除されるのではなく、コンテンツ ツリーの外に保存されます。アーカイブされたアイテムはいつでも復元できます。

    アイテムを削除すると、そのアイテムはごみ箱に移動します。ごみ箱からアイテムを復元したり、永久に削除したりすることができます ( :doc:`restore-or-remove-a-deleted-item` )。
...
.. warning:: 
    ...
    結果の削除をクリックすると、結果の項目は警告も確認もなく削除されます。しかし、項目を削除して後悔した場合は、Sitecore のゴミ箱を開いて ( :doc:`restore-or-remove-a-deleted-item` )、削除した項目を復元することができます。
