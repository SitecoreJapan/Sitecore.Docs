...
2. アイテムのパブリッシュウィザードで、[設定] ページでパブリッシュモードを指定します。
    ...
    * リパブリッシュ - すべてをパブリッシュします。リパブリッシュは、ターゲット データベースで選択されたアイテムを、変更されていなくても、マスター データベースの同等のアイテムで上書きします。このようにして、廃止されたバージョンはすべてターゲット データベースから削除されます。リパブリッシュを使用して、マスター データベースのバックアップを復元したり、新しいコンテンツ言語、新しいパブリッシング ターゲット、またはその他のシステム アイテムを追加したりすることができます。
...
4. 選択したアイテムに関連するすべてのアイテムを公開するには、[関連するアイテムを公開] を選択します。一般的に、このオプションを選択することをお勧めします。関連アイテムには次のようなものがあります。
